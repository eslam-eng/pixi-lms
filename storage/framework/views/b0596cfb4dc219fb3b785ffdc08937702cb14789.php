    ...
    <script>
        (function () {
            ...
            $.toast({
                ...
                bgColor: '<?php if(session()->get('toast')['status'] == 'success'): ?> #578994 <?php else: ?> #f63c3c <?php endif; ?>',
                textColor: 'white',
                hideAfter: 10000,
...
<?php /**PATH D:\xampp7\htdocs\pixi-lms\resources\views/web/default/layouts/app.blade.php ENDPATH**/ ?>