        ...
        <div class="col-12 col-md-6">
            <form action="/admin/settings/main" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="" value="<?php echo e((!empty($itemValue) and !empty($itemValue['site_name'])) ? $itemValue['site_name'] : old('site_name')); ?>" class="form-control "/>
                </div>

                <div class="form-group">
                    <label><?php echo e(trans('admin/main.site_email')); ?></label>
                    <input type="text" name="" value="<?php echo e((!empty($itemValue) and !empty($itemValue['site_email'])) ? $itemValue['site_email'] : old('site_email')); ?>" class="form-control "/>
                </div>

                <div class="form-group">
                    <label><?php echo e(trans('admin/main.site_phone')); ?></label>
                    <input type="text" name="" value="<?php echo e((!empty($itemValue) and !empty($itemValue['site_phone'])) ? $itemValue['site_phone'] : old('site_phone')); ?>" class="form-control "/>
                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp7\htdocs\pixi-lms\resources\views/admin/settings/general/basic.blade.php ENDPATH**/ ?>